...
const LIGHT = {
  ...
  tickerBg:'#1c1a16', navBg:'rgba(250,250,248,0.97)',
  border:'#d8d5d0', border2:'#c4c1bc',
  gold:'#b8750c', goldLight:'#cc880f', goldDim:'#9a6008',
  red:'#dc2626', amber:'#b45309',
  text:'#1a1a1a', text2:'#4a4a4a', text3:'#737373',
  heading:'#0f0f0f',
  chatBg:'#ffffff', chatToolbar:'#f2f1ee',
  chatUser:'#eceae6', chatUserBorder:'#d8d5d0',
  chatMonday:'rgba(184,117,12,.05)', chatMondayBorder:'rgba(184,117,12,.18)',
  featBg:'#f2f1ee', featHover:'#e8e6e2',
  gridLine:'rgba(184,117,12,.04)',
  glow:'rgba(184,117,12,.07)', glow2:'rgba(184,117,12,.09)',
  scanline:'rgba(184,117,12,.10)',
  stepActive:'#fafaf8', stepInactive:'#f2f1ee',
  pricingBg:'#ffffff', pricingBorder:'rgba(184,117,12,.35)',
  pricingShadow:'0 8px 40px rgba(184,117,12,.10)',
  compBg:'#f2f1ee',
  faqOpen:'#fafaf8',
  testimonialBg:'#ffffff',
  footerBg:'#1c1a16', footerBorder:'rgba(184,117,12,.10)',
  calendarBg:'#f2f1ee',
  badgeBg:'rgba(184,117,12,.07)', badgeBorder:'rgba(184,117,12,.22)',
  dataRowBg:'rgba(184,117,12,.04)', dataRowBorder:'rgba(184,117,12,.15)',
  toggleBg:'#eceae6', toggleBorder:'#d8d5d0',
  btnText:'#ffffff',
  footerText:'#c0a060', footerMuted:'#888880', footerPowered:'#666660',
}
        ...
        <div style={{ maxWidth:860, margin:'0 auto' }}>
          ...
          <div className="plans-grid" style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:1, background:T.border }}>
            ...
            <div style={{ background:T.pricingBg, border:`1px solid ${T.pricingBorder}`, padding:'28px 24px', position:'relative', boxShadow:T.pricingShadow }}>
              ...
              <div style={{ fontFamily:"'Cormorant Garamond',serif", fontSize:'clamp(20px,3.5vw,28px)', color:T.gold, fontStyle:'italic', fontWeight:600, lineHeight:1.1, marginBottom:18 }}>Every advantage.</div>
              <div style={{ display:'flex', alignItems:'baseline', gap:3, marginBottom:4 }}>
                <span style={{ fontFamily:"'Cormorant Garamond',serif", fontSize:'clamp(38px,7vw,54px)', fontWeight:700, color:T.gold, lineHeight:1 }}>${edgePrice.split('.')[0]}</span>
      ...
      <section className="section-pad" style={{ padding:'88px 24px', borderTop:`1px solid ${T.border}`, textAlign:'center', position:'relative', overflow:'hidden', backgroundImage:`linear-gradient(${T.gridLine} 1px,transparent 1px),linear-gradient(90deg,${T.gridLine} 1px,transparent 1px)`, backgroundSize:'52px 52px' }}>
        ...
        <div style={{ maxWidth:540, margin:'0 auto', position:'relative' }}>
          ...
          <p style={{ fontSize:'clamp(12px,3vw,13px)', color:T.text2, marginBottom:30, lineHeight:1.75, letterSpacing:'0.02em' }}>
            From $79.99/month. No contracts. Cancel anytime.<br />5-day free trial included.
          </p>
